class CfgAmmo
{
	...
	/*class LLW_Hellfire_Ammo_N_AS: SubmunitionBase
	{
		submunitionAmmo = "LLW_Hellfire_Ammo_N";
		submunitionCount = 1;
	...
	class LLW_Hydra_Ammo_MPSM: SubmunitionBase
	{
		model = "LLW_Apache\70mmRocket\70mmRocket.p3d";
...
class CfgWeapons
{
	...
	//======================================================================================================
	class LLW_FFAR_Weapon_HEDP: RocketPods
	{
		magazines[] = 
		{
	...
	class LLW_FFAR_Weapon_MPSM: RocketPods
	{
		magazines[] = 
		{
	...
	class LLW_FFAR_Weapon_WP: RocketPods
	{
		magazines[] = 
		{
	...
	class LLW_FFAR_Weapon_FL: RocketPods
	{
		magazines[] = 
		{
			"LLW_FFAR_3Rnd_Magazine_FL",
			"LLW_FFAR_4Rnd_Magazine_FL",
			"LLW_FFAR_6Rnd_Magazine_FL",
			"LLW_FFAR_8Rnd_Magazine_FL",
			"LLW_FFAR_12Rnd_Magazine_FL",
			"LLW_FFAR_19Rnd_Magazine_FL",
			"LLW_FFAR_24Rnd_Magazine_FL",
			"LLW_FFAR_38Rnd_Magazine_FL"
		};
		displayName = "Hydra 70";
		modes[] = {"Far_AI","Burst1","Burst2","Burst4"};
		cursor = "EmptyCursor";
	...
	class LLW_Hellfire_Weapon_N: MissileLauncher
	{
		...
		magazines[] = 
		{
			...
			/*"LLW_Hellfire_4Rnd_Magazine_N_AS",*/
