...
class cfgWeapons
{
	...
	class Dutch_Beret_RoyalArmy: ItemCore
	{
		...
		picture = "\NLD_Infantry_Units\Units\Beret\uim\RoyalArmy.jpg";
		model = "\A3\Characters_F\Common\headgear_beret01";
		hiddenSelectionsTextures[] = {"\NLD_Infantry_Units\Units\Beret\RoyalArmy.paa"};
	...
	class Dutch_Beret_Commandos: ItemCore
	{
		...
		picture = "\NLD_Infantry_Units\Units\Beret\uim\Commandos.jpg";
		model = "\A3\Characters_F\Common\headgear_beret01";
	...
	class Dutch_Beret_Luchtmobiele_Brigade: ItemCore
	{
		...
		picture = "\NLD_Infantry_Units\Units\Beret\uim\11AirManoeuvreBrigade.jpg";
		model = "\A3\Characters_F\Common\headgear_beret01";
